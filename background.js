...
//     lastStatusPayload = message.payload
...
//     lastGraphPayload = message.payload
//     safeBroadcast(message)
//   },
...
//     if (lastStatusPayload) safeBroadcast({ type: EVENT_TYPES.STATUS, payload: lastStatusPayload })
//     if (lastGraphPayload)
//       safeBroadcast({ type: EVENT_TYPES.FIBER_GRAPH, payload: lastGraphPayload })
//   }
// }
